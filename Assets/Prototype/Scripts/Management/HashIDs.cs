...
public class HashIDs : MonoBehaviour
{
    ...
    public int VerticalSpeedFloat { get; private set; }
    ...
    public int JumpBool { get; private set; }

    public int OnGroundBool { get; private set; }
    ...
    private void Awake()
    {
        ...
        VerticalSpeedFloat = Animator.StringToHash("VerticalSpeed");
